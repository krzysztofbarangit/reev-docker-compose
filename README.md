...
wget -O /tmp/annonars-clinvar-minimal-grch37-20231015+0.24.1.tar.gz \
  https://github.com/bihealth/annonars-data-clinvar/releases/download/clinvar-weekly-20231015/annonars-clinvar-minimal-grch37-20231015+0.24.1.tar.gz
wget -O /tmp/annonars-clinvar-minimal-grch38-20231015+0.24.1.tar.gz \
  https://github.com/bihealth/annonars-data-clinvar/releases/download/clinvar-weekly-20231015/annonars-clinvar-minimal-grch38-20231015+0.24.1.tar.gz
...
ln -sr .dev/volumes/reev-static/data/download/annonars/annonars-clinvar-minimal-grch37-20231015+0.24.1 \
  .dev/volumes/reev-static/data/annonars/grch37/clinvar
ln -sr .dev/volumes/reev-static/data/download/annonars/annonars-clinvar-minimal-grch38-20231015+0.24.1 \
  .dev/volumes/reev-static/data/annonars/grch38/clinvar

wget -O /tmp/annonars-clinvar-genes-20231015+0.24.1.tar.gz \
  https://github.com/bihealth/annonars-data-clinvar/releases/download/clinvar-weekly-20231015/annonars-clinvar-genes-20231015+0.24.1.tar.gz
